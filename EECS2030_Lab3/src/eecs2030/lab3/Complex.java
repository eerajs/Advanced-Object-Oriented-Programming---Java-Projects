...
public final class Complex {
	...
	public boolean equals(Object obj) {
		...
		return (obj != null && obj.getClass() == Complex.class && 
				this.re == ((Complex) obj).re() && 
	...
	public static Complex valueOf(String s) {
		...
		if ((parts.size() == 3) && (parts.get(1).charAt(0) == '+' || parts.get(1).charAt(0) == '-') && (parts.get(2).endsWith("i"))) {
			
			double real, imag;
			
			real = Double.parseDouble(parts.get(0));
			imag = Double.parseDouble(parts.get(2).substring(0, parts.get(2).length() - 1));
			imag *= (parts.get(1).charAt(0) == '-') ? -1.0d : 1.0d;
